...
enum L10n {
    private static let values: [String: [AppLanguage: String]] = [
        ...
        "queue": [.english: "Job queue", .vietnamese: "Hàng đợi job"],
        "queueHelp": [.english: "Add jobs with `apprun queue add -- <command>`, run them with `apprun queue run`. Pause lets the current job finish, then waits.", .vietnamese: "Thêm job bằng `apprun queue add -- <lệnh>`, chạy bằng `apprun queue run`. Tạm dừng sẽ để job hiện tại chạy xong rồi chờ."],
        "queueEmpty": [.english: "Queue is empty", .vietnamese: "Hàng đợi trống"],
        "runningNow": [.english: "Running", .vietnamese: "Đang chạy"],
        "paused": [.english: "Paused", .vietnamese: "Đã tạm dừng"],
        "pause": [.english: "Pause", .vietnamese: "Tạm dừng"],
        "resume": [.english: "Resume", .vietnamese: "Tiếp tục"],
        "editQueue": [.english: "Edit", .vietnamese: "Sửa"],
        "openLogs": [.english: "Logs", .vietnamese: "Log"],
        "clear": [.english: "Clear", .vietnamese: "Xoá hết"],
        "batteryUntil": [.english: "Battery until", .vietnamese: "Pin đủ đến"],
        "batterySoonTitle": [.english: "LidRun: battery won't last", .vietnamese: "LidRun: pin không đủ"],
